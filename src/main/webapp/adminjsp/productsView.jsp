    ...
    <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>${sessionScope.user.user_name}</span></a>
            </div>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>All Products <small>Listing design</small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-striped projects">
	                 ...
	                 <c:forEach items="${requestScope.productlist}" var="elementuser"> 
                              <tr>
                          
                          <td>
                            ${elementuser.productName}
                          </td>
                          ...
                          <td>
                            ...
                            <a href="ProductProfServ?prodcutid=${elementuser.id}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                            <a href="LoadProduct?prodcutid=${elementuser.id}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Edit </a>
                            <a href="DeleteProductServ?prodcutid=${elementuser.id}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Delete </a>
