...
<jsp:include page="singleProductServletApp"></jsp:include>
<c:set var="prodObj" value="${requestScope.singleProduct}" />
                        ...
                        <div class="sngl-top">
                            ...
                            <div class="col-md-7 single-top-right">
                                <div class="single-para simpleCart_shelfItem">
                                    <h2><c:out value="${prodObj.productName}"/></h2>

                                    <h5 class="item_price"><c:out value="${prodObj.productPrice}"/></h5>
                                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>

                                    <ul class="tag-men">
                                        <li><span>Category</span>
                                            <span class="women1">:
                                                <c:out value="${prodObj.productCategory}"/>
                                            </span>
                                        </li>
                                        <li><span>Quantity</span>
                                            <span class="women1">:
                                                <c:out value="${prodObj.productQuantity}"/>
                                            </span>
                                        </li>
                                    </ul>
