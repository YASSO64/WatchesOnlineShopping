<%-- 
    ...
    Created on : Mar 13, 2018, 1:44:30 AM
    Author     : Rania
--%>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-windows"></i> User View<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="${sessionScope.user.profile_pic}" alt="">${sessionScope.user.user_name}
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="/OnlineShoppingCartPro/UserProfileServ?userid=${sessionScope.user.id}"> Profile</a></li>
                    <li>
                      <a href="javascript:;">
                    ...
                    <li><a href="/OnlineShoppingCartPro/Logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          ...
                          <img class="img-responsive avatar-view" src="${requestScope.user.profile_pic}" alt="Avatar" title="Change the avatar">
                        </div>
                      </div>
                      <h3>${requestScope.user.user_name}  </h3>

                      <ul class="list-unstyled user_data">
                          
                          
                        <li><i class="fa fa-map-marker user-profile-icon"></i> ${requestScope.user.user_address}
                        </li>
                          <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> ${requestScope.user.user_email}
                        </li>

                        <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> ${requestScope.user.user_job}
                        </li>
                        
                         <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> ${requestScope.user.birthDate}
                        </li>
                         <li>
                             <h3> Credit Limit:</h3><i class="fa fa-briefcase user-profile-icon"></i> ${requestScope.user.credit_number}
                        </li>
                      ...
                      <!-- start skills -->
                      <h4>${requestScope.user.user_name}</h4>
                      <ul class="list-unstyled user_data">
                        <li>
                          <p>Watches for Men</p>
